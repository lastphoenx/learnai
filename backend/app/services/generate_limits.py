...
def acquire_batch_generate_rate_slot(*, user_id: str) -> None:
    """Ein Batch-Import zählt als eine stündliche Generierung (nicht pro Einheit)."""
    client = _redis_client()
    if not client:
