...
_PROFILE_OVERLAYS: dict[str, str] = {
    ...
    "nmg": (
        ...
        "- Tabellen/Zeitstrahlen mit historischen Epochen und Jahreszahlen: Epochen in key_terms "
        "(term, definition mit Datumsbereich, role «historische Epoche»/«Zeitperiode») — "
        "NUR wenn im Material tatsächlich Epochen/Jahreszahlen vorkommen (z. B. Steinzeit, "
        "Mittelalter, Antike, «450 bis 1050»). Bei Raumorientierung, Plänen, Ansichten oder "
        "reinen Fachbegriffen ohne Geschichte: role leer lassen, kein «historische Epoche».\n"
