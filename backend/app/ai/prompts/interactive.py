...
CARDS_SYSTEM = (
    ...
    "- answer: zuerst das Ergebnis (Zahl/Satz oder Gleichung, z. B. 7 · 3.04 = 21.28), "
    "danach der Lösungsweg. Niemals nur den Weg ohne Resultat.\n"
    "- Bei mehreren Lösungswegen: 'Variante 1 (Aus dem Heft): …' und "
    "'Variante 2 (Alternativer Weg): …' — jede mit Gleichung und Endergebnis.\n"
...
TYPED_CARDS_SYSTEM = (
    ...
    "- Bei Rechen-/Ergebnisfragen (merk und mental): answer beginnt mit dem Endergebnis "
    "(Gleichung, z. B. 7 · 3.04 = 21.28), danach der Weg. Nie nur die Herleitung.\n"
    "- Mehrere Wege: 'Variante 1 (Aus dem Heft): …' und 'Variante 2 (Alternativer Weg): …', "
    "jede mit Gleichung und Resultat; Badge-Text genau so.\n"
...
QUIZ_SYSTEM = (
    ...
    "- explanation: Bei question_type=calculation mindestens zwei, höchstens drei Lösungswege als "
    "'Variante 1 (...)' und 'Variante 2 (...)'. Jede Variante ist eine Herleitung mit mindestens "
    "einer ausgerechneten Gleichung (z. B. 8 × 1 = 8) — keine Rezepte ohne Zahlen.\n"
    "- Variante 1: Strategie und Wortlaut aus dem Didaktik-Block, Schritte auf DIESE Aufgabe rechnen.\n"
    "- Weitere Varianten: eine andere, unabhängige Strategie aus dem Material — nicht dieselbe "
    "Herleitung umformulieren. Welche Strategie das ist, hängt vom Fach und Didaktik-Block ab.\n"
