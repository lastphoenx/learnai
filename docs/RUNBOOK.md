...
Stand: August 2026. Produktion: **CT 135** (`192.168.131.45`), öffentlich via **CT 108 nginx** → `https://learn.santinel.li`.
...
```
Browser → CT 108 nginx (learn.santinel.li)
...
```bash
docker compose exec redis redis-cli GET ollama:inference:lock
```
