...
| Modul | Rolle |
|-------|--------|
| `camera_visibility.py` | Spalten-**Maximalhöhe** lesbar; Parallelstrahlen wie **orthographische** `BuildingThreeCanvas`-Kamera (nicht perspektivisch vom einen Kamerapunkt) |
